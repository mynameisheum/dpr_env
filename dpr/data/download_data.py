...
RESOURCES_MAP = {
    ...
    "data.retriever.squad1-train": {
        "s3_url": "https://dl.fbaipublicfiles.com/dpr/data/retriever/biencoder-squad1-train"
                  ".json.gz",
        "original_ext": ".json",
        "compressed": True,
    ...
    "data.retriever.qas.squad1-test": {
        ...
        "original_ext": ".csv",
        "compressed": False,
        "desc": "squad1 test subset for Retriever validation and IR results generation",
    },
