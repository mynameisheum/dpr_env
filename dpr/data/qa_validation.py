...
def calculate_matches(
    ...
    questions_answers_docs = zip(answers, closest_docs) #(10570,a) , (10570,)
    scores = processes.map(get_score_partial, questions_answers_docs) # [f,f,f,t,f,..][][]..

    logger.info("Per question validation results len=%d", len(scores))

    n_docs = len(closest_docs[0][0])
    top_k_hits = [0] * n_docs
    for question_hits in scores: # 10570
