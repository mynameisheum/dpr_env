...
class DenseFlatIndexer(DenseIndexer):
    ...
    def search_knn(self, query_vectors: np.array, top_docs: int) -> List[Tuple[List[object], List[float]]]:
        # print(query_vectors, top_docs)
        # print(query_vectors.shape,query_vectors.dtype,) # float 32
        scores, indexes = self.index.search(query_vectors, top_docs) # query_vectors = (10570, 768)
        # convert to external ids # scores , indexs = (1057000,100),(1057000,100)
